...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white pt-12 pb-10 md:pt-12 md:pb-24">
      <div className="max-w-[90%] mx-auto">
        ...
        <div className="flex flex-col items-center gap-3 md:flex-row md:justify-between md:gap-8 pt-6 md:pt-8 border-t border-slate-100">
          <p className="text-[11px] font-normal uppercase tracking-[0.2em] text-slate-400 text-center leading-relaxed">
